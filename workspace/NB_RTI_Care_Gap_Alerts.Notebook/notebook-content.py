...
try:
    df_care_gaps = spark.table("care_gaps")
...
try:
    df_hedis = spark.table("hedis_measures")
except Exception:
    try:
...
df_output.write.format("delta").mode("overwrite").saveAsTable("rti_care_gap_alerts")
